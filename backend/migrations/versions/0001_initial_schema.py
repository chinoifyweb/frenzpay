...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("kyc_tier", sa.Enum("TIER_0","TIER_1","TIER_2","TIER_3", name="kyctier", create_type=False), nullable=False, server_default="TIER_0"),
        sa.Column("kyc_status", sa.Enum("PENDING","IN_REVIEW","APPROVED","REJECTED", name="kycstatus", create_type=False), nullable=False, server_default="PENDING"),
        sa.Column("account_status", sa.Enum("ACTIVE","SUSPENDED","CLOSED", name="accountstatus", create_type=False), nullable=False, server_default="ACTIVE"),
    ...
    op.create_table(
        ...
        sa.Column("purpose", sa.Enum("SIGNUP","LOGIN","TRANSACTION","PASSWORD_RESET", name="otppurpose", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("tier", sa.Enum("TIER_1","TIER_2","TIER_3", name="kyc_tier_level", create_type=False), nullable=False),
        sa.Column("status", sa.Enum("PENDING","VERIFIED","REJECTED","EXPIRED", name="kyc_submission_status", create_type=False), nullable=False, server_default="PENDING"),
        sa.Column("provider", sa.Enum("DOJAH","SMILE_ID","MANUAL", name="kyc_provider", create_type=False), nullable=False, server_default="DOJAH"),
    ...
    op.create_table(
        ...
        sa.Column("document_type", sa.Enum("NIN","BVN","PASSPORT","DRIVERS_LICENSE","VOTERS_CARD","UTILITY_BILL","SELFIE","BANK_STATEMENT","EMPLOYMENT_LETTER","CAC_CERT", name="document_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("screening_type", sa.Enum("SANCTIONS","PEP","ADVERSE_MEDIA", name="screening_type", create_type=False), nullable=False),
        sa.Column("result", sa.Enum("CLEAR","HIT","REVIEW", name="screening_result", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("currency", sa.Enum("USD","GBP","EUR","NGN","KES","GHS","XAF","XOF", name="currency", create_type=False), nullable=False),
        ...
        sa.Column("status", sa.Enum("ACTIVE","FROZEN","CLOSED", name="wallet_status", create_type=False), nullable=False, server_default="ACTIVE"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("type", sa.Enum("DEPOSIT","WITHDRAWAL","FX_CONVERSION","INTERNAL_TRANSFER","FEE","REFUND", name="transaction_type", create_type=False), nullable=False),
        sa.Column("status", sa.Enum("INITIATED","PENDING","PROCESSING","COMPLETED","FAILED","REVERSED", name="transaction_status", create_type=False), nullable=False, server_default="INITIATED"),
    ...
    op.create_table(
        ...
        sa.Column("wallet_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("entry_type", sa.Enum("DEBIT","CREDIT", name="entry_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("BANK_ACCOUNT","MOBILE_MONEY","STABLECOIN_WALLET", name="beneficiary_type", create_type=False), nullable=False),
        sa.Column("country", sa.String(2), nullable=False),
        sa.Column("currency", sa.String(10), nullable=False),
