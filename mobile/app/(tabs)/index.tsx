      ...
      >
        ...
        >
          {mockWallets.map((wallet) => (
            <View
              key={wallet.id}
              style={[styles.walletCard, { borderLeftColor: getCurrencyColor(wallet.currency) }]}
            >
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity style={styles.actionCard} onPress={() => router.push('/(tabs)/withdraw')}>
          ...
          <TouchableOpacity style={styles.actionCard} onPress={() => router.push('/(tabs)/accounts')}>
          ...
          <TouchableOpacity style={styles.actionCard}>
            ...
            <Text style={styles.actionLabel}>Invite{'\n'}Friends</Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 14, color: 'rgba(255,255,255,0.5)', marginBottom: 4 },
  ...
  sectionTitle: { fontSize: 17, fontWeight: '700', color: '#fff', paddingHorizontal: 20, marginBottom: 14 },
  walletsScroll: { paddingHorizontal: 20, gap: 12, paddingBottom: 4 },
  walletCard: {
    width: CARD_WIDTH * 0.78, backgroundColor: 'rgba(255,255,255,0.05)',
    borderRadius: 16, padding: 20, borderLeftWidth: 4, borderWidth: 1,
  ...
  walletBalance: { fontSize: 24, fontWeight: '800', color: '#fff', marginBottom: 4 },
  walletAvailable: { fontSize: 13, color: 'rgba(255,255,255,0.4)' },
  actionsGrid: {
    flexDirection: 'row', paddingHorizontal: 20, gap: 12, marginBottom: 28,
  },
  actionCard: {
    flex: 1, backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 14,
    padding: 14, alignItems: 'center', gap: 10, borderWidth: 1,
    borderColor: 'rgba(255,255,255,0.06)',
  },
  actionIcon: { width: 46, height: 46, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  actionLabel: { fontSize: 11, fontWeight: '600', color: 'rgba(255,255,255,0.7)', textAlign: 'center' },
  recentHeader: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
  ...
  txRowBorder: { borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  txIcon: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  txInfo: { flex: 1 },
  txDesc: { fontSize: 14, fontWeight: '600', color: '#fff', marginBottom: 3 },
